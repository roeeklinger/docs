...
description: "ByteStack uses an AI model to classify every mention as positive, negative, or neutral. Learn how to request sentiment analysis and read the scored results."
---
...
<Steps>
  ...
  <Step title="Visualize in the dashboard">
    After the query completes, open **Dashboard → Jobs** and select the result. ByteStack renders a **Sentiment Breakdown** chart showing the share of positive, negative, and neutral mentions. Hover over any segment to see the count and the top example mentions for that category.
