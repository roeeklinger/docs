...
description: "ByteStack queries let you ask questions in plain English. Learn how to write effective prompts, what parameters are available, and how results are structured."
---
...
<Steps>
  ...
  <Step title="ByteStack executes the query">
...
<AccordionGroup>
  <Accordion title="What makes a good query prompt?">
    ...
    A vague prompt like "what do people say about my brand" will return broad, unfocused results. A specific prompt like "What are the top complaints about Acme's pricing on Reddit and X in the last 30 days?" gives ByteStack a clear scope and returns actionable data.
