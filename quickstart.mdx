---
title: "Get started with ByteStack"
description: "Learn how to create an account, generate an API key, and run your first ByteStack query in under five minutes."
---
...
<Steps>
  ...
  <Step title="Create your account">
    Go to [app.bytestack.dev/signup](https://app.bytestack.dev/signup) and create a free account. You can sign up with Google, GitHub, or SSO, or register with an email address and password.
  ...
  <Step title="View the results">
    ...
    You can also view query results in the **Dashboard** → **Jobs** panel of your project workspace, where ByteStack displays charts and sentiment breakdowns alongside the raw counts.
  </Step>
